...
findplacefromtext/json"
            ...
            url_place_prepare = Request('GET', url_place,
                                        params=place_payloads).prepare()
            ...
            url_wiki_get_pages_prepare = Request('GET', url_wiki_get_pages,
                                                 params=get_pages_payload)
            url_wiki_get_pages_prepare.prepare()
            url_wiki_result_pages = "https://fr.wikipedia.org/api/rest_v1/\
page/summary/Cite_Paradis"
            ...
            with requests_mock.Mocker() as m:
                ...
                response = c.post("process_msg",
                                  data={"msg_content": "OpenClassrooms"})
